...
let param = {};
let region = new Array(91);
let weather = new Array(91);
let tem = new Array(91);
let region_num = [10, 22, 65, 43, 69];
...
index.post('/postdata/indexpage', function (req, res, next) {
    res.json({ travel: travel });
});
axios_1.default.post('/api', { travel: travel })
    .then(res => {
